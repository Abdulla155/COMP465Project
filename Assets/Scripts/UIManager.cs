...
public class UIManager : MonoBehaviour
{
    ...
    private void PlatformManagerVer2_OnPlatformManagerUpdateUI()
    {
        ...
        if(txtSelectedNodePosition!=null)
            txtSelectedNodePosition.text = string.Format("");
    }
    ...
    public void ButtonClicked(Button b)
    {
        switch(b.name)
        {
            ...
            case "butPlatformConfiguration":
                {
                    SceneManager.LoadScene("Setup");
                    break;
                }
            case "butPlatformProgramming":
                {
                    SceneManager.LoadScene("Programming");
                    break;
                }
            case "butPlatformSimulate":
                {
                    SceneManager.LoadScene("Simulate");
                    break;
                }

            case "butBuildPlatform":
                {
